...
export default function AuthPage() {
  ...
  return (
    <div className="bg-slate-900 flex justify-center items-center flex-col font-sans min-h-screen p-6">
      <div className={`bg-white rounded-[18px] shadow-[0_18px_36px_rgba(0,0,0,0.25),0_12px_14px_rgba(0,0,0,0.22)] relative overflow-hidden w-full max-w-md md:max-w-225 min-h-[500px] md:min-h-140`}>

        {/* Sign Up Form */}
        <div className={`
          ${isSignUp ? "block" : "hidden"}
          md:block md:absolute md:top-0 md:h-full md:left-0 md:w-1/2
          md:transition-all md:duration-500 md:ease-in-out
          ${isSignUp
            ? "md:translate-x-full md:opacity-100 md:z-[5] md:pointer-events-auto"
            : "md:translate-x-0 md:opacity-0 md:z-[1] md:pointer-events-none"
          }
        `}>
        ...
        <div className={`
          ...
          md:transition-all md:duration-500 md:ease-in-out
          ${isSignUp
            ? "md:opacity-0 md:z-[1] md:pointer-events-none"
            : "md:opacity-100 md:z-[2] md:pointer-events-auto"
          }
        `}>
        ...
        <div className={`hidden md:block absolute top-0 left-1/2 w-1/2 h-full overflow-hidden transition-transform duration-500 ease-in-out z-[100] ${
          isSignUp ? "-translate-x-full" : "translate-x-0"
        }`}>
          <div className={`text-white relative -left-full h-full w-[200%] transition-transform duration-500 ease-in-out ${
            ...
            <div
              ...
              style={{ backgroundImage: "url('/images/signup-bg.webp')", backgroundSize: "cover", backgroundPosition: "center" }}
            >
            ...
            <div
              ...
              style={{ backgroundImage: "url('/images/signin-bg.webp')", backgroundSize: "cover", backgroundPosition: "center" }}
            >
              <div className="absolute inset-0 bg-[#0F172A]/70" />
              <div className="relative z-10">
